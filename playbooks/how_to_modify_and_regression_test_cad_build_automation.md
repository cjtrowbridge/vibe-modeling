...
4. Keep mutable generated staging under `.tmp/scad/<design>/`; install only
   the validated, flat artifact set into `output/<design>/`. Immutable outputs
   use `revisions/<design>/rev_000N/`.
