...
// 2026-09-16): thickens the band z = microsd_max_z()..case_outer_height()
// into the cavity; its internal face moves x = wall_thickness ->
// x = wall_thickness + top_band_cavity_extension. It is a flat retention
// ledge; its 1 mm shelf thickness is a user-directed exception to
// minimum_internal_edge_width (asserted with a 1.0 mm floor in
// case_body.scad). The is_undef fallbacks keep the older rev_0001..rev_0003
// configs rendering unchanged.
