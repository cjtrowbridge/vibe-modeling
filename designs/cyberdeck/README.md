...
- Revision `rev_0030` moves the screen-face USB column outside the complete `260 mm` screen-bracket tolerance envelope and keeps its USB-A flange aligned to the outside wall with the required `3 mm` land. See [docs/rev_0030_usb_bracket_tolerance_edge.md](docs/rev_0030_usb_bracket_tolerance_edge.md).
- Revision `rev_0029` moved the USB column outside the `250 mm` bracket body but omitted its `5 mm` side tolerance; it is superseded by `rev_0030`. See [docs/rev_0029_usb_screen_bracket_clearance.md](docs/rev_0029_usb_screen_bracket_clearance.md).
