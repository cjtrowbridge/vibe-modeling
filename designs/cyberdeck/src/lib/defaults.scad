...
chamber_left_drawer_mount_nut_flat_d = 5.5;
chamber_left_drawer_mount_nut_trap_depth = 2.8;
chamber_left_drawer_mount_nut_boss_d = 12.5;
chamber_left_drawer_mount_nut_boss_depth = 3.6;
