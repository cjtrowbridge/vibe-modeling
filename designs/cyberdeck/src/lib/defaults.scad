...
chamber_display_wedge_x = chamber_display_mount_width + 2 * chamber_display_mount_side_margin;
chamber_display_void_x = 210.0;
chamber_display_void_h = 87.0;
chamber_display_void_depth = 25.4;
chamber_display_mount_screw_x_offset = 115.0;
chamber_display_mount_screw_face_spacing = 76.2;
chamber_display_mount_screw_clearance_d = 5.5;
...
chamber_display_seam_rail_vertical_screw_count = 2;
chamber_display_seam_rail_vertical_screw_bottom_inset = 65.0;
chamber_display_seam_rail_vertical_screw_spacing = 18.0;
...
chamber_io_panel_usb_a_left_x = -11.75;
chamber_io_panel_usb_a_right_x = 23.0;
chamber_io_panel_outer_label_size = 2.4;
chamber_io_panel_outer_label_line_gap = 3.6;
chamber_io_panel_usb_a_label_size = 2.8;
chamber_io_panel_usb_a_label_gap = 1.5;
...
chamber_lid_mount_inset = 8.0;
chamber_lid_mount_pad_size = 16.0;
...
chamber_tray_backplate_side_clearance = 2.0;
