...
chamber_left_drawer_backplate_screw_side_offset = 7.0;
chamber_left_drawer_backplate_screw_z_offset = 8.0;
chamber_left_drawer_backplate_single_row_z = 33.0;
chamber_left_drawer_backplate_nut_flat_d = 5.5;
chamber_left_drawer_backplate_nut_trap_depth = 2.8;
chamber_left_drawer_backplate_nut_boss_d = 12.5;
chamber_left_drawer_backplate_nut_boss_depth = 3.6;
