...
chamber_display_right_arcade_button_x = 136.5;
chamber_display_right_arcade_button_face_spacing = 40.0;
...
chamber_left_drawer_backplate_screw_edge_margin = 3.0;
chamber_left_drawer_backplate_screw_side_offset = 6.5;
