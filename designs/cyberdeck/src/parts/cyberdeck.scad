...
function chamber_assembly_right_x() =
  compact_body_enabled
    ? chamber_display_wedge_right_x()
    : chamber_piece_x;
function chamber_display_reference_center_x() = chamber_dome_area_x / 2;
function chamber_display_legacy_half_x() = chamber_display_wedge_x / 2;
function chamber_display_mount_left_half_x() =
  chamber_display_mount_width / 2 + chamber_display_mount_side_margin;
function chamber_display_left_controls_and_mount_half_x() =
  max(
    chamber_display_left_arcade_button_x
      + chamber_arcade_button_outer_d / 2
      + minimum_internal_edge_width,
    chamber_display_mount_screw_right_x
      + chamber_display_mount_screw_clearance_d / 2
      + minimum_internal_edge_width
  );
function chamber_display_right_half_x() =
  compact_body_enabled
    ? max(
...
function chamber_left_required_piece_w() =
  2 * chamber_wall
  + chamber_left_seam_reinforcement_t
  + chamber_left_drawer_outer_w()
  + chamber_left_drawer_backplate_w()
  + chamber_left_drawer_divider_w;
function chamber_display_left_half_x() =
  compact_body_enabled
    ? max(
        chamber_display_mount_left_half_x(),
        chamber_display_left_controls_and_mount_half_x(),
        chamber_display_reference_center_x()
          - chamber_split_x()
          + chamber_left_required_piece_w()
      )
    : chamber_display_legacy_half_x();
function chamber_display_center_x() = chamber_display_reference_center_x();
function chamber_display_wedge_left_x() =
  chamber_display_center_x() - chamber_display_left_half_x();
function chamber_display_wedge_right_x() =
  chamber_display_center_x() + chamber_display_right_half_x();
function chamber_display_wedge_actual_w() =
  chamber_display_wedge_right_x() - chamber_display_wedge_left_x();
...
function chamber_display_mount_left_screw_x() =
  chamber_display_mount_screw_right_x;
function chamber_display_mount_right_screw_x() =
  chamber_display_mount_screw_right_x;
...
function chamber_io_panel_nominal_w() =
  ...
  - 2 * (chamber_wall + chamber_lid_clearance);
function chamber_io_panel_xa() =
  chamber_display_center_x() - chamber_io_panel_nominal_w() / 2;
...
function chamber_tray_backplate_screw_center_z() =
  chamber_tray_backplate_single_row_z;
...
function chamber_rpi_side_tray_screw_y_abs() =
  ...
  + chamber_rpi_side_tray_backplate_screw_side_offset;
function chamber_rpi_side_tray_screw_center_z() =
  chamber_rpi_side_tray_backplate_single_row_z;
...
function chamber_left_inner_xa() =
  chamber_assembly_left_x() + chamber_wall;
function chamber_left_inner_xb() =
  chamber_split_x() - chamber_wall - chamber_left_seam_reinforcement_t;
function chamber_left_inner_w() =
  chamber_left_inner_xb() - chamber_left_inner_xa();
function chamber_left_drawer_inner_w() =
  chamber_left_drawer_payload_w + 2 * chamber_left_drawer_fit_clearance;
function chamber_left_drawer_outer_w() =
  chamber_left_drawer_inner_w() + 2 * chamber_left_drawer_wall;
function chamber_left_drawer_outer_h() =
  chamber_left_drawer_floor_t + chamber_left_drawer_side_wall_h;
function chamber_left_drawer_opening_w() =
  chamber_left_drawer_outer_w() + 2 * chamber_left_drawer_slide_clearance;
function chamber_left_drawer_opening_h() =
  chamber_left_drawer_outer_h() + 2 * chamber_left_drawer_slide_clearance;
function chamber_left_drawer_opening_top_z() =
  chamber_left_drawer_opening_z0 + chamber_left_drawer_opening_h();
function chamber_left_drawer_fastener_nut_corner_d() =
  chamber_left_drawer_fastener_nut_flat_d / cos(30);
function chamber_left_drawer_fastener_envelope_d() =
  max(
    chamber_left_drawer_fastener_head_d,
    chamber_left_drawer_fastener_nut_corner_d()
  );
function chamber_left_drawer_backplate_screw_x_abs() =
  max(
    chamber_left_drawer_opening_w() / 2
      + chamber_left_drawer_slide_clearance
      + chamber_left_drawer_fastener_envelope_d() / 2
      + minimum_internal_edge_width,
    chamber_left_drawer_outer_w() / 2
      + chamber_left_drawer_divider_w
      + chamber_left_drawer_fastener_envelope_d() / 2
      + chamber_left_drawer_fastener_install_clearance
  );
function chamber_left_drawer_backplate_w() =
  2 * (
    chamber_left_drawer_backplate_screw_x_abs()
    + chamber_left_drawer_fastener_envelope_d() / 2
    + minimum_internal_edge_width
  );
function chamber_left_drawer_backplate_h() =
  chamber_left_drawer_opening_top_z()
  + chamber_left_drawer_backplate_screw_clearance_d / 2
  + chamber_left_drawer_backplate_screw_edge_margin;
function chamber_left_drawer_backplate_body_h() =
  chamber_left_drawer_backplate_h() - chamber_left_drawer_opening_z0;
...
function chamber_left_battery_lane_center_x() =
  ...
  + chamber_left_drawer_outer_w() / 2;
function chamber_left_divider_xa() =
  chamber_left_battery_lane_center_x() + chamber_left_drawer_outer_w() / 2;
function chamber_left_divider_xb() =
  chamber_left_divider_xa() + chamber_left_drawer_divider_w;
function chamber_left_meshtastic_lane_center_x() =
  chamber_left_divider_xb() + chamber_left_drawer_outer_w() / 2;
function chamber_keyboard_lid_rail_bottom_z() =
  chamber_keyboard_lid_rail_center_z() - chamber_keyboard_lid_rail_h / 2;
function chamber_left_lid_swept_bottom_z() =
  chamber_keyboard_lid_rail_bottom_z() - chamber_lid_clearance;
function chamber_left_drawer_divider_top_z() =
  min(
    chamber_left_drawer_opening_top_z(),
    chamber_left_lid_swept_bottom_z() - minimum_internal_edge_width
  );
function chamber_left_drawer_top_z() =
  chamber_left_drawer_opening_z0 + chamber_left_drawer_outer_h();
function chamber_left_drawer_fastener_to_opening_gap() =
  chamber_left_drawer_backplate_screw_x_abs()
  - chamber_left_drawer_slide_clearance
  - chamber_left_drawer_opening_w() / 2
  - chamber_left_drawer_fastener_envelope_d() / 2;
function chamber_left_drawer_fastener_to_divider_gap() =
  chamber_left_drawer_backplate_screw_x_abs()
  - chamber_left_drawer_outer_w() / 2
  - chamber_left_drawer_divider_w
  - chamber_left_drawer_fastener_envelope_d() / 2;
function chamber_left_drawer_fastener_to_outer_wall_gap() =
  chamber_left_drawer_side_margin()
  + chamber_left_drawer_outer_w() / 2
  - chamber_left_drawer_backplate_screw_x_abs()
  - chamber_left_drawer_fastener_envelope_d() / 2;
function chamber_left_drawer_fastener_to_backplate_edge_gap() =
  chamber_left_drawer_backplate_w() / 2
  - chamber_left_drawer_backplate_screw_x_abs()
  - chamber_left_drawer_fastener_envelope_d() / 2;
function chamber_left_drawer_front_y() =
  -chamber_piece_y / 2;
function chamber_left_drawer_back_y() =
  chamber_piece_y / 2;
function chamber_left_drawer_floor_inner_d() =
  chamber_left_drawer_payload_d + 2 * chamber_left_drawer_fit_clearance;
function chamber_left_drawer_floor_outer_d() =
  chamber_left_drawer_floor_inner_d() + chamber_left_drawer_backplate_t;
...
function chamber_front_led_strip_passage_bolt_ligament(i) =
  ...
  - chamber_joint_bolt_clearance_d / 2
  - chamber_front_led_strip_passage_d / 2;
function chamber_left_seam_counterbore_floor_margin(i) =
  chamber_bolt_z(i)
  - chamber_left_seam_counterbore_d / 2
  - chamber_bottom;
function chamber_left_seam_counterbore_top_margin(i) =
  chamber_total_z()
  - chamber_bolt_z(i)
  - chamber_left_seam_counterbore_d / 2;
function chamber_left_seam_counterbore_front_rear_margin(i) =
  chamber_piece_y / 2
  - abs(chamber_bolt_y(i))
  - chamber_left_seam_counterbore_d / 2;
function chamber_left_seam_counterbore_led_ligament(i) =
  sqrt(
    pow(
      chamber_bolt_y(i) - chamber_front_led_strip_passage_center_y(),
      2
  ...
  - chamber_left_seam_counterbore_d / 2
  - chamber_front_led_strip_passage_d / 2;
function chamber_left_seam_counterbore_passthrough_ligament(i, j) =
  sqrt(
    pow(chamber_bolt_y(i) - chamber_passthrough_y(j), 2)
    + pow(chamber_bolt_z(i) - chamber_joint_center_z, 2)
  )
...
module _assert_dims() {
  ...
  assert(chamber_display_wedge_actual_w() >= chamber_display_mount_width + 2 * chamber_display_mount_side_margin,
    "display wedge width must include the display width and side margins");
  assert(chamber_display_wedge_actual_w() <= 2 * chamber_piece_x,
    "display wedge width exceeds the assembled chamber width");
  assert(!compact_body_enabled
      || (abs(chamber_assembly_left_x() - chamber_display_wedge_left_x()) < 0.001
        && abs(chamber_assembly_right_x() - chamber_display_wedge_right_x()) < 0.001),
    "compact chamber exterior sides must use the continuous display-profile shell boundaries");
  assert(chamber_display_void_x > 0 && chamber_display_void_h > 0,
    "display void dimensions must be > 0");
  assert(chamber_display_void_x < chamber_display_wedge_actual_w(),
  ...
  assert(chamber_display_mount_left_screw_x()
      > chamber_display_void_x / 2
    && chamber_display_mount_left_screw_x()
      < chamber_display_left_half_x(),
    "left display mount screws must land outside the screen opening and inside the left wedge");
  assert(chamber_display_mount_right_screw_x() > chamber_display_void_x / 2
    && chamber_display_mount_right_screw_x() < chamber_display_mount_width / 2,
    "right display mount screws must land in the right display-side flange");
  assert(abs(chamber_display_mount_left_screw_x()
      - chamber_display_mount_right_screw_x()) < 0.001,
    "left and right display mount columns must remain symmetric about the screen datum");
  assert(chamber_display_mount_left_screw_x()
      < chamber_display_left_arcade_button_x,
    "left display mount column must remain between the screen and arcade buttons");
  assert(chamber_display_mount_right_screw_x()
      < chamber_display_right_screen_port_x,
    "right display mount column must remain between the screen and USB ports");
  ...
  assert(chamber_shell_wedge_tray_overlap >= minimum_structural_overlap,
    "any profile-shell to flat-shell transition must use the required structural overlap");
  ...
  for (i = [0 : 1]) {
    ...
    for (sz = [-1, 1]) {
      ...
      assert(chamber_display_face_hardware_to_mount_screw_ligament(
        ...
        "display-face left arcade-button envelopes must clear the screen mount holes");
    }
  }
  ...
  assert(!compact_body_enabled
      || abs(chamber_display_right_usb_a_right_outer_edge_ligament()
          - minimum_internal_edge_width) < 0.01,
    "compact display USB column must remain aligned to its outer wall at the minimum edge margin");
  ...
  for (sz = [-1, 1]) {
    assert(chamber_display_face_hardware_to_mount_screw_ligament(
          ...
          chamber_io_panel_usb_a_mount_d,
          chamber_display_right_usb_a_face_offset(),
          chamber_display_mount_right_screw_x(),
          sz * chamber_display_mount_screw_face_spacing / 2
        ) >= minimum_internal_edge_width,
    ...
    assert(chamber_display_face_hardware_to_mount_screw_ligament(
      ...
      "display-face right USB-A envelope must clear the screen mount holes");
    assert(chamber_display_face_hardware_to_mount_screw_ligament(
          chamber_display_right_screen_port_x,
          chamber_control_usb_c_jack_d,
          chamber_display_right_usb_c_face_offset(),
  ...
  assert(chamber_tray_backplate_screw_center_z()
      > chamber_tray_backplate_bottom_z()
        + chamber_tray_backplate_screw_clearance_d / 2
        + chamber_tray_backplate_screw_edge_margin
    && chamber_tray_backplate_screw_center_z()
  ...
  assert(chamber_rpi_side_tray_screw_center_z()
      > chamber_rpi_side_tray_opening_z0
        + chamber_rpi_side_tray_backplate_screw_clearance_d / 2
        + chamber_rpi_side_tray_backplate_screw_edge_margin
    && chamber_rpi_side_tray_screw_center_z()
  ...
  assert(chamber_left_drawer_wall >= minimum_wall_thickness
    && chamber_left_drawer_floor_t >= minimum_wall_thickness
    && chamber_left_drawer_divider_w >= minimum_wall_thickness,
    "left-chamber drawer walls, floor, and divider must meet the minimum wall thickness");
  assert(chamber_left_drawer_payload_w == 60
  ...
  assert(chamber_left_drawer_opening_top_z() <= chamber_total_z() - minimum_internal_edge_width,
    "left-chamber drawer openings must retain top-wall material");
  assert(chamber_left_battery_lane_center_x() - chamber_left_drawer_backplate_w() / 2
      >= chamber_assembly_left_x() + minimum_internal_edge_width
    && chamber_left_battery_lane_center_x() + chamber_left_drawer_backplate_w() / 2
      <= chamber_split_x() - minimum_internal_edge_width,
    "battery drawer backplate must remain inside the left chamber width with edge margin");
  assert(chamber_left_meshtastic_lane_center_x() - chamber_left_drawer_backplate_w() / 2
      >= chamber_assembly_left_x() + minimum_internal_edge_width
    && chamber_left_meshtastic_lane_center_x() + chamber_left_drawer_backplate_w() / 2
      <= chamber_split_x() - minimum_internal_edge_width,
    "Meshtastic drawer backplate must remain inside the left chamber width with edge margin");
  assert(chamber_left_divider_xa() - chamber_left_battery_lane_center_x()
      >= chamber_left_drawer_outer_w() / 2
  ...
  assert(chamber_left_drawer_fastener_head_d
      >= chamber_left_drawer_backplate_screw_clearance_d
    && chamber_left_drawer_fastener_nut_flat_d
      >= chamber_left_drawer_backplate_screw_clearance_d,
    "left drawer head and nut envelopes must exceed the M3 through-hole diameter");
  assert(chamber_left_drawer_fastener_to_opening_gap()
      >= minimum_internal_edge_width,
    "left drawer fastener seating envelopes must retain minimum material from the drawer openings");
  assert(chamber_left_drawer_fastener_to_divider_gap()
      >= chamber_left_drawer_fastener_install_clearance,
    "left drawer divider-side fasteners must have usable nut/head clearance from the divider");
  assert(chamber_left_drawer_fastener_to_outer_wall_gap()
      >= chamber_left_drawer_fastener_install_clearance,
    "left drawer outer fasteners must have usable nut/head clearance from the side wall");
  assert(chamber_left_drawer_fastener_to_backplate_edge_gap()
      >= minimum_internal_edge_width,
    "left drawer fastener seating envelopes must retain minimum backplate edge material");
  assert(chamber_left_drawer_backplate_screw_x_abs()
      - chamber_left_drawer_backplate_screw_clearance_d / 2
      > chamber_left_drawer_opening_w() / 2
        + chamber_left_drawer_slide_clearance,
    "left drawer through-holes must cut solid lands outside the drawer openings");
  assert(chamber_left_drawer_backplate_screw_center_z()
      > chamber_left_drawer_opening_z0
        + chamber_left_drawer_backplate_screw_clearance_d / 2
        + chamber_left_drawer_backplate_screw_edge_margin
    && chamber_left_drawer_backplate_screw_center_z()
      < chamber_left_drawer_backplate_h()
        - chamber_left_drawer_backplate_screw_clearance_d / 2
        - chamber_left_drawer_backplate_screw_edge_margin,
    "left drawer backplate screws must retain minimum vertical edge material");
  assert(chamber_left_drawer_divider_top_z()
      >= chamber_left_drawer_top_z(),
    "left drawer divider must remain tall enough to support the drawer ends");
  assert(chamber_left_lid_swept_bottom_z()
      - chamber_left_drawer_divider_top_z()
      >= minimum_internal_edge_width,
    "left drawer divider must clear the lid seating and insertion envelope by the structural minimum");
  assert(chamber_power_cell_rear_x() + chamber_control_usb_c_jack_d / 2
      + minimum_internal_edge_width
      <= chamber_left_meshtastic_lane_center_x() - chamber_left_drawer_backplate_w() / 2,
    "rear Meshtastic drawer backplate must clear the existing Power Cell opening");
  ...
  assert(chamber_left_seam_counterbore_d > chamber_joint_bolt_clearance_d
      && chamber_left_seam_counterbore_depth > 0
      && chamber_left_seam_reinforcement_t >= chamber_left_seam_counterbore_depth,
    "left seam counterbores must be larger than the bolt holes and fit inside the reinforcement thickness");
  ...
  for (i = [0 : chamber_joint_bolt_count - 1]) {
    ...
    assert(chamber_left_seam_counterbore_front_rear_margin(i)
        >= minimum_internal_edge_width,
      "left seam counterbores need minimum material to the front/rear wall edges");
    assert(chamber_left_seam_counterbore_floor_margin(i)
        >= minimum_internal_edge_width,
      "left seam counterbores need minimum material above the floor");
    assert(chamber_left_seam_counterbore_top_margin(i)
        >= minimum_internal_edge_width,
      "left seam counterbores need minimum material below the open top");
    assert(chamber_left_seam_counterbore_led_ligament(i)
        >= minimum_internal_edge_width,
      "left seam counterbores need minimum material from the LED-strip passage");
    for (j = [0 : chamber_joint_passthrough_count - 1]) {
      ...
      assert(chamber_left_seam_counterbore_passthrough_ligament(i, j)
          >= minimum_internal_edge_width,
        "left seam counterbores need minimum material from the chamber passthroughs");
    }
  }
}
...
module _chamber_shell(side, center_x, assembly_position) {
  ...
  has_left_flat_tray = wedge_global_xa > global_body_xa + 0.01;
  has_right_flat_tray = wedge_global_xb < global_body_xb - 0.01;
  left_flat_tray_xa = global_body_xa + model_x_offset;
  left_flat_tray_xb = min(
    global_body_xb,
    wedge_global_xa + chamber_shell_wedge_tray_overlap
  ) + model_x_offset;
  right_flat_tray_xa = max(
    global_body_xa,
    wedge_global_xb - chamber_shell_wedge_tray_overlap
  ) + model_x_offset;
  right_flat_tray_xb = global_body_xb + model_x_offset;
  keep_wedge_left_wall = abs(wedge_global_xa - global_body_xa) < 0.01;
  keep_wedge_right_wall = abs(wedge_global_xb - global_body_xb) < 0.01;
  ...
  union() {
    if (has_left_flat_tray && left_flat_tray_xb > left_flat_tray_xa) {
      _chamber_flat_tray(
        left_flat_tray_xa,
        left_flat_tray_xb,
        -chamber_piece_y / 2,
    ...
    if (has_right_flat_tray && right_flat_tray_xb > right_flat_tray_xa) {
      _chamber_flat_tray(
        right_flat_tray_xa,
        right_flat_tray_xb,
        -chamber_piece_y / 2,
...
module _right_chamber_tray_backplate_screw_cuts(xa, xb) {
  for (sx = [-1, 1]) {
    _right_chamber_tray_backplate_screw_cut(xa, xb, sx, 0);
  }
}
...
module _chamber_display_mount_screw_cuts(center_x) {
  for (sz = [-1, 1]) {
    _chamber_display_mount_screw_cut(
      center_x - chamber_display_mount_left_screw_x(),
      sz * chamber_display_mount_screw_face_spacing / 2
    );
    _chamber_display_mount_screw_cut(
      center_x + chamber_display_mount_right_screw_x(),
      sz * chamber_display_mount_screw_face_spacing / 2
    );
  }
}

module _left_chamber_drawer_front_opening_cut(center_x) {
  translate([
    center_x,
    chamber_left_drawer_front_y(),
    chamber_left_drawer_opening_z0 + chamber_left_drawer_opening_h() / 2
  ])
    cube([
      chamber_left_drawer_opening_w(),
      chamber_wall * 6,
      chamber_left_drawer_opening_h()
    ], center = true);
}

module _left_chamber_drawer_rear_opening_cut(center_x) {
  translate([
    center_x,
    chamber_left_drawer_back_y(),
    chamber_left_drawer_opening_z0 + chamber_left_drawer_opening_h() / 2
  ])
    cube([
      chamber_left_drawer_opening_w(),
...
module _left_chamber_drawer_front_backplate_screw_cut(center_x, sx, sz) {
  translate([
    center_x + sx * chamber_left_drawer_backplate_screw_x_abs(),
    chamber_left_drawer_front_y(),
    chamber_left_drawer_backplate_screw_center_z()
  ])
    rotate([90, 0, 0])
      cylinder(
        d = chamber_left_drawer_backplate_screw_clearance_d,
        h = chamber_wall * 6,
        center = true,
        $fn = 32
      );
...
module _left_chamber_drawer_rear_backplate_screw_cut(center_x, sx, sz) {
  translate([
    center_x + sx * chamber_left_drawer_backplate_screw_x_abs(),
    chamber_left_drawer_back_y(),
    chamber_left_drawer_backplate_screw_center_z()
...
module _left_chamber_drawer_front_backplate_screw_cuts(center_x) {
  for (sx = [-1, 1]) {
    _left_chamber_drawer_front_backplate_screw_cut(center_x, sx, 0);
  }
}

module _left_chamber_drawer_rear_backplate_screw_cuts(center_x) {
  for (sx = [-1, 1]) {
    _left_chamber_drawer_rear_backplate_screw_cut(center_x, sx, 0);
  }
}

module _left_chamber_seam_reinforcement(model_x_offset) {
  translate([
    chamber_split_x() - chamber_wall - chamber_left_seam_reinforcement_t + model_x_offset,
    -chamber_piece_y / 2 + chamber_wall,
    chamber_bottom
  ])
    cube([
      chamber_left_seam_reinforcement_t,
      chamber_piece_y - 2 * chamber_wall,
      chamber_internal_clearance_z
    ], center = false);
}

module _left_chamber_drawer_divider() {
  translate([
    chamber_left_divider_xa(),
    -chamber_piece_y / 2 + chamber_wall - minimum_structural_overlap,
    chamber_bottom
  ])
    cube([
      chamber_left_drawer_divider_w,
      chamber_piece_y - 2 * chamber_wall + 2 * minimum_structural_overlap,
      chamber_left_drawer_divider_top_z() - chamber_bottom
    ], center = false);
}
...
module _chamber_body(side, assembly_position, label_text) {
  ...
  display_void_cut_x = chamber_display_center_x() + model_x_offset;
    ...
    union() {
      difference() {
        union() {
          ...
          if (side < 0) {
            _left_chamber_drawer_divider();
            _left_chamber_seam_reinforcement(model_x_offset);
          }
        ...
        for (i = [0 : chamber_joint_bolt_count - 1]) {
          ...
          if (side < 0) {
            _left_chamber_bolt_counterbore_cut(joint_face_x, i);
          }
        }
      }
...
module _right_chamber_tray_body() {
  ...
  difference() {
    ...
    for (sx = [-1, 1]) {
      _right_chamber_tray_backplate_screw_cut_for_tray(sx, 0);
    }
...
module _right_chamber_rpi_side_tray_body() {
  ...
  difference() {
    ...
    for (sy = [-1, 1]) {
      _right_chamber_rpi_side_tray_backplate_screw_cut(sy, 0);
    }
...
module _left_drawer_front_backplate_screw_cut_for_drawer(sx, sz) {
  translate([
    sx * chamber_left_drawer_backplate_screw_x_abs(),
    chamber_left_drawer_backplate_t / 2,
    chamber_left_drawer_backplate_screw_center_z()
  ])
    rotate([90, 0, 0])
      cylinder(
        d = chamber_left_drawer_backplate_screw_clearance_d,
        h = chamber_left_drawer_backplate_t + 1.2,
        center = true,
        $fn = 32
      );
}
...
module _left_chamber_bolt_counterbore_cut(joint_face_x, i) {
  translate([
    ...
    rotate([0, 90, 0])
      cylinder(
        d = chamber_left_seam_counterbore_d,
        h = chamber_left_seam_counterbore_depth + 0.4,
        center = true,
        $fn = 36
      );
}

module _left_drawer_rear_backplate_screw_cut_for_drawer(sx, sz) {
  translate([
    sx * chamber_left_drawer_backplate_screw_x_abs(),
    -chamber_left_drawer_backplate_t / 2,
    chamber_left_drawer_backplate_screw_center_z()
...
module _left_battery_drawer_body() {
  outer_w = chamber_left_drawer_outer_w();
  floor_d = chamber_left_drawer_floor_outer_d();
  ...
  difference() {
    union() {
      ...
      translate([
        -outer_w / 2,
        0,
        chamber_left_drawer_opening_z0 + chamber_left_drawer_floor_t
      ])
        cube([
          chamber_left_drawer_wall,
          floor_d,
          chamber_left_drawer_side_wall_h
        ], center = false);

      translate([
        outer_w / 2 - chamber_left_drawer_wall,
        0,
        chamber_left_drawer_opening_z0 + chamber_left_drawer_floor_t
      ])
        cube([
...
module _left_meshtastic_drawer_body() {
  outer_w = chamber_left_drawer_outer_w();
  floor_d = chamber_left_drawer_floor_outer_d();
...
module cyberdeck_left_battery_drawer() {
  _assert_dims();
  _left_battery_drawer_body();
}

module cyberdeck_left_meshtastic_drawer() {
  _assert_dims();
  _left_meshtastic_drawer_body();
}
